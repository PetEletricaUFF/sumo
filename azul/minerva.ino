...
void loop() {
  ...
  if (!ja_andou) {
    // Etapa 1: anda para frente por 400ms
    SET_MOTORS(255, 255);
    delay(150);

    // Para por segurança antes de girar
    SET_MOTORS(0, 0);
    delay(100);

    ja_andou = true; // Marca que o movimento inicial foi feito
  }

  // Etapa 2: gira indefinidamente no próprio eixo
  SET_MOTORS(105, -105);
}
